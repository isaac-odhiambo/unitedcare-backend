...
# =========================================================
# 🔐 LOGIN SERIALIZER (WITH ACCOUNT LOCKING, NO OTP BLOCK)
# =========================================================
...
# NOTE:
# This serializer assumes your view will verify the reset token/code
# before calling save(), or will pass the verified user through context.
# =========================================================
